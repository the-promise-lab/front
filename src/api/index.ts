...
export type { CreateSlotDto } from './models/CreateSlotDto';
...
export { $CreateGameSessionDto } from './schemas/$CreateGameSessionDto';
export { $CreateSlotDto } from './schemas/$CreateSlotDto';
